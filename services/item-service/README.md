...
Service ini khusus menangani operasional barang atau aset dalam sistem microservices Docker Compose ini. Service ini telah di-decouple (lepas) dari dependensi langsung ke model `User` untuk fleksibilitas di masa depan.
