...
Terima kasih telah tertarik untuk berkontribusi! Untuk menjaga ekosistem microservices Docker Compose ini tetap bersih dan skalabel, harap ikuti panduan berikut.
...
2.  **Shared Logic**: Jika Anda menemukan logika yang sama di dua service, pertimbangkan untuk menduplikasi sementara guna menjaga independensi service.
3.  **Independensi**: Setiap service harus bisa dijalankan dan di-test secara mandiri menggunakan `uv`.
